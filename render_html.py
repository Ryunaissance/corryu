...
#nav-auth {{ display:flex; align-items:center; gap:6px; opacity:0; pointer-events:none; transition:opacity 0.2s ease; }}
body.auth-loaded #nav-auth {{ opacity:1; pointer-events:auto; }}
#nav-mob-login-btn {{ opacity:0; pointer-events:none; transition:opacity 0.2s ease; }}
body.auth-loaded #nav-mob-login-btn {{ opacity:1; pointer-events:auto; }}
