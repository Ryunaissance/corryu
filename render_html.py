    ...
    function showToast(msg, durationMs) {{
        ...
        if (!el) {{
            ...
            el.style.cssText = 'position:fixed;bottom:80px;left:50%;transform:translateX(-50%);' +
                'background:#1e293b;color:#e2e8f0;padding:9px 18px;border-radius:10px;font-size:0.85rem;' +
                'border:1px solid rgba(255,255,255,0.12);box-shadow:0 4px 20px rgba(0,0,0,0.5);' +
                'z-index:9999;pointer-events:none;transition:opacity 0.3s;opacity:0;white-space:nowrap;';
