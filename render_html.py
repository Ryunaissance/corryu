...
<div id="nav-mob-drawer" class="nav-mob-drawer">
  <!-- nav.js의 injectMobileDrawer()가 allLinks 배열로 동적 생성 (단일 진실의 원천) -->
</div>
...
<script src="/dashboard-overrides.js"></script>
<script src="/dashboard.js"></script>
<script src="/dashboard-likes.js"></script>
...
def main():
    ...
    if not os.path.exists(etf_data_path):
        print(f"ERROR: {etf_data_path} 없음. scripts/compute_all.py 를 먼저 실행하세요.")
        sys.exit(1)
