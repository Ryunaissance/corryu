...
const SUPP = {
  'SPY':  { exp:'0.0945%', issuer:'State Street Global Advisors', bench:'S&P 500',           structure:'UIT', div:'분기 배당', divYield:'1.24%', numH:503,
  ...
  'QQQ':  { exp:'0.20%',  issuer:'Invesco',                       bench:'Nasdaq-100',         structure:'Open-End',  div:'분기 배당', divYield:'0.55%', numH:101,
  ...
  'IVV':  { exp:'0.03%',  issuer:'BlackRock (iShares)',           bench:'S&P 500',             structure:'Open-End',  div:'분기 배당', divYield:'1.26%', numH:503,
            desc:'iShares Core S&P 500 ETF. 0.03%의 최저 수수료로 S&P 500 지수를 추종합니다.',
            holdings:[['AAPL','Apple Inc.',7.32],['MSFT','Microsoft Corp.',6.81],['NVDA','NVIDIA Corp.',5.94],['AMZN','Amazon.com Inc.',3.78],['META','Meta Platforms',2.65],['GOOGL','Alphabet Class A',2.10],['GOOG','Alphabet Class C',1.82],['BRK.B','Berkshire Hathaway B',1.63],['LLY','Eli Lilly & Co.',1.52],['JPM','JPMorgan Chase',1.47]],
            perf:{'1M':2.3,'3M':5.1,'YTD':8.7,'1Y':22.4,'3Y_ann':12.1,'5Y_ann':14.7} },
  'VOO':  { exp:'0.03%',  issuer:'Vanguard',                      bench:'S&P 500',             structure:'Open-End',  div:'분기 배당', divYield:'1.25%', numH:503,
  ...
  'VTI':  { exp:'0.03%',  issuer:'Vanguard',                      bench:'CRSP US Total Market',structure:'Open-End',  div:'분기 배당', divYield:'1.35%', numH:3615,
  ...
  'GLD':  { exp:'0.40%',  issuer:'State Street Global Advisors', bench:'LBMA Gold Price',      structure:'Grantor Trust', div:'무배당', divYield:'0%', numH:1,
  ...
  'TLT':  { exp:'0.15%',  issuer:'BlackRock (iShares)',           bench:'ICE US Treasury 20+Y', structure:'Open-End', div:'월 배당', divYield:'4.12%', numH:26,
  ...
  'XLK':  { exp:'0.09%',  issuer:'State Street Global Advisors', bench:'S&P Technology Select Sector', structure:'Open-End', div:'분기 배당', divYield:'0.68%', numH:67,
  ...
  'XLF':  { exp:'0.09%',  issuer:'State Street Global Advisors', bench:'S&P Financials Select Sector', structure:'Open-End', div:'분기 배당', divYield:'1.68%', numH:72,
  ...
  'XLV':  { exp:'0.09%',  issuer:'State Street Global Advisors', bench:'S&P Healthcare Select Sector', structure:'Open-End', div:'분기 배당', divYield:'1.42%', numH:63,
  ...
  'XLE':  { exp:'0.09%',  issuer:'State Street Global Advisors', bench:'S&P Energy Select Sector', structure:'Open-End', div:'분기 배당', divYield:'3.42%', numH:22,
  ...
  'IWM':  { exp:'0.19%',  issuer:'BlackRock (iShares)',           bench:'Russell 2000',        structure:'Open-End', div:'분기 배당', divYield:'1.23%', numH:2000,
  ...
  'VEA':  { exp:'0.05%',  issuer:'Vanguard',                      bench:'FTSE Dev. All Cap ex US', structure:'Open-End', div:'반기 배당', divYield:'2.98%', numH:3900,
  ...
  'VWO':  { exp:'0.08%',  issuer:'Vanguard',                      bench:'FTSE Emerging Markets', structure:'Open-End', div:'반기 배당', divYield:'3.42%', numH:5600,
  ...
  'VNQ':  { exp:'0.13%',  issuer:'Vanguard',                      bench:'MSCI US IMI Real Estate 25/50', structure:'Open-End', div:'분기 배당', divYield:'3.85%', numH:163,
  ...
  'HYG':  { exp:'0.48%',  issuer:'BlackRock (iShares)',           bench:'iBoxx USD Liquid HY', structure:'Open-End', div:'월 배당', divYield:'5.82%', numH:1195,
  ...
  'BND':  { exp:'0.03%',  issuer:'Vanguard',                      bench:'Bloomberg US Aggregate', structure:'Open-End', div:'월 배당', divYield:'3.72%', numH:10418,
  ...
  'GBTC': { exp:'1.50%',  issuer:'Grayscale Investments',         bench:'Bitcoin Price',        structure:'Spot BTC ETF', div:'무배당', divYield:'0%', numH:1,
  ...
  'SQQQ': { exp:'0.95%',  issuer:'ProShares',                     bench:'Nasdaq-100 × −3',      structure:'Open-End', div:'분기 배당', divYield:'3.21%', numH:0,
  ...
  'PEY':  { exp:'0.53%',  issuer:'Invesco',                       bench:'NASDAQ US Dividend Achievers 50', structure:'Open-End', div:'월 배당', divYield:'4.87%', numH:50,
  ...
  'UYR':  { exp:'0.95%',  issuer:'ProShares',                     bench:'Dow Jones US Real Estate × 2', structure:'Open-End', div:'분기 배당', divYield:'1.84%', numH:30,
  ...
  'IWF':  { exp:'0.19%',  issuer:'BlackRock (iShares)',           bench:'Russell 1000 Growth',  structure:'Open-End', div:'분기 배당', divYield:'0.52%', numH:415,
